...
/**
 * Write a description of class ApiPracticeRunner here.
 *
...
public class ApiPracticeRunner {
	...
	private static void print(String methodCall, double result, double expected) {
	...
	private static void print(String methodCall, String result,String expected) {
		System.out.print("Result of " + methodCall + ": [" + result + "] ");
	...
	private static void print(String methodCall, boolean result,boolean expected) {
		System.out.print("Result of " + methodCall + ": [" + result + "] ");
		if (result == expected) System.out.println("Good!");
		else System.out.println("Incorrect. Expected [" + expected + "]");
	}
